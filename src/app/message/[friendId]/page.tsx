...
import { getFriend, getConfig } from "@/lib/store";
...
export default function MessagePage() {
  ...
  const messageWords = friend.message.split(" ");
      ...
      <div className="relative z-10 w-full max-w-xl mx-4 py-12">
        ...
        {showEnvelope ? (
          ...
          >
            ...
            >
              {friend.imageUrl ? (
                <div className="w-12 h-12 rounded-xl overflow-hidden mb-2 border border-violet-400/30">
          ...
          >
            ...
            >
              {friend.imageUrl ? (
                <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg mb-2 border border-violet-400/30">
                  <img src={friend.imageUrl} alt={friend.name} className="w-full h-full" style={getImageStyle(friend)} />
                </div>
              ) : (
            ...
            >
              ...
              <p 
                className={`message-${friend.messageStyle} text-lg md:text-xl text-white/90 text-justify w-full break-words leading-relaxed`}
